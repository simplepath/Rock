        ...
        public override void PreSaveChanges( Rock.Data.DbContext dbContext, System.Data.Entity.Infrastructure.DbEntityEntry entry )
        {
            ...
            switch ( entry.State )
            {
                case System.Data.Entity.EntityState.Added:
                    {
                        ...
                        HistoryChangeList.AddChange( History.HistoryVerb.Add, History.HistoryChangeType.Record, acct, Amount.FormatAsCurrency(), null );
                        break;
                    }
                ...
                case System.Data.Entity.EntityState.Deleted:
                    {
                        string acct = History.GetValue<FinancialAccount>( this.Account, this.AccountId, rockContext );
                        HistoryChangeList.AddChange( History.HistoryVerb.Delete, History.HistoryChangeType.Record, acct, Amount.FormatAsCurrency(), null );
                        break;
                    }
            }
        ...
        public override void PostSaveChanges( DbContext dbContext )
        {
            if ( HistoryChangeList.Any() )
            {
                ...
                if ( txn != null && txn.BatchId != null )
                {
                    ...
                    batchHistory.AddChange(History.HistoryVerb.Modify, History.HistoryChangeType.Record, $"Transaction ID:{txn.Id}", null, null );
