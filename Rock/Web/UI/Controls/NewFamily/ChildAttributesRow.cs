...
namespace Rock.Web.UI.Controls
{
    ...
    /// </summary>
    public class NewChildAttributesRow : CompositeControl
    {
        /// <summary>
        ...
        protected override void CreateChildControls()
        {
            ...
            foreach ( var attribute in AttributeList )
            {
                ...
                var attributeControl = attribute.AddControl( Controls, string.Empty, string.Empty, false, true, labelText: attribute.Key );
