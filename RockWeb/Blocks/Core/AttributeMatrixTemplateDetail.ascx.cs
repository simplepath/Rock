    ...
    public partial class AttributeMatrixTemplateDetail : RockBlock, IDetailBlock
    {
        ...
        protected void btnSave_Click( object sender, EventArgs e )
        {
            ...
            rockContext.WrapTransaction( () =>
            {
                ...
                var attributes = attributeService.Get( entityTypeIdAttributeMatrix, "AttributeMatrixTemplateId", attributeMatrixTemplate.Id.ToString(), true );
        ...
        public void ShowDetail( int attributeMatrixTemplateId )
        {
            ...
            var attributeService = new AttributeService( rockContext );
            AttributesState = attributeService.Get( new AttributeMatrixItem().TypeId, "AttributeMatrixTemplateId", attributeMatrixTemplate.Id.ToString(), true ).AsQueryable()
                .OrderBy( a => a.Order )
                .ThenBy( a => a.Name )
                .ToList();
