    ...
    public partial class Bio : PersonBlock
    {
        ...
        private void SetPersonName()
        {
            ...
            else
            {
                ...
                {
                    nameText = string.Format( "<span class='first-word firstname'>{0}</span> <span class='middlename'>{1}</span> <span class='lastname'>{2}</span>", Person.NickName, Person.MiddleName, Person.LastName );
                }
                else
                {
                    nameText = string.Format( "<span class='first-word firstname'>{0}</span> <span class='lastname'>{1}</span>", Person.NickName, Person.LastName );
                }
